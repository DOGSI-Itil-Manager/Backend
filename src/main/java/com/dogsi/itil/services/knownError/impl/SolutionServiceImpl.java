...
public class SolutionServiceImpl implements SolutionService {
    ...
    public void saveSolution(SolutionDto dto) {
        ...
        var knownError = knownErrorRepository.findById(dto.getKnownErrorId()).orElseThrow(() -> {
            throw new ItemNotFoundException("KnownError with id " + dto.getKnownErrorId() + " not found");
        });        
        solution.addKnownError(knownError);
